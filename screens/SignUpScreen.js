    ...
    <View className="bg-white h-full w-full">
      ...
      <View className="h-full w-full  flex justify-around pt-48 ">
       ...
       <Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} className="rounded-2xl w-full bg-black/5 p-5">
        ...
        <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="rounded-2xl w-full bg-black/5 p-5">
          <TextInput placeholder="Email" placeholderTextColor={'grey'}/>
        </Animated.View>
        <Animated.View  entering={FadeInDown.delay(600).duration(1000).springify()} className="rounded-2xl w-full bg-black/5 p-5 m-3">
